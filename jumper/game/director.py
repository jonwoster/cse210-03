...
class Director:
    ...
    def __init__(self):
        ...
        self._secret_word = Word_Generator()._generate_word()
    ...
    def _display_status(self):
        ...
        self._show_word = self._evaluate_guess._get_word_printout(self._secret_word, self._user_guess, self._hidden_word)
        # Print out the word with letters and/or underscores using terminal service
        self._terminal_service._write_text(f"\n{self._show_word}\n")
        
        # Get the image of the parachute and jumper from evaluate guess
        self._image = self._evaluate_guess._get_jumper_image(self._user_guess, self._secret_word)
        # Print out the image of the parachute and jumper using terminal service
        self._terminal_service._write_text(f"{self._image}")
    ...
    def _capture_guess(self):
        ...
        # Returns nothing.
        self._user_guess = self._terminal_service._read_letter("Guess a letter [a-z]: ")
